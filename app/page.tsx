...
export default function Home() {
  return (
    <main style={{ paddingTop: 68, fontFamily: "'DM Sans', system-ui, sans-serif", backgroundColor: '#08080F', minHeight: '100vh' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 60 }}>
            <a href="#download" style={{
              ...
              color: '#fff', boxShadow: '0 8px 28px rgba(0,212,255,.25)',
          ...
          <div style={{ display: 'flex', gap: 32 }}>
            {STATS.map((s, i) => (
              <div key={s.label} style={{
                ...
                <div style={{ fontSize: 22, fontWeight: 900, color: '#fff', letterSpacing: '-.02em' }}>{s.val}</div>
                <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginTop: 4, letterSpacing: '.04em', fontWeight: 600 }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>

        {/* Mükemmel Glow Efektli Telefon Mockup'ı */}
      ...
      {/* ══════════════════ FEATURES GRID ══════════════════ */}
      <section style={{ background: '#0E0E18', padding: '96px 48px', borderTop: '1px solid rgba(255,255,255,0.03)' }}>
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: 56 }}>
            ...
            <h2 style={{
              ...
              color: '#fff', marginBottom: 12, lineHeight: 1.12,
            }}>
              Built for serious gamers
            </h2>
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.6)', maxWidth: 440, fontWeight: 500 }}>
          ...
          <div style={{
            ...
            {FEATURES.map(f => (
              ...
              >
                ...
                <span style={{ fontSize: 13, fontWeight: 800, color: f.color, letterSpacing: '.02em' }}>
                  Learn more →
                </span>
              </Link>
            ))}
      ...
      {/* ══════════════════ GAMING DNA SHOWCASE ══════════════════ */}
      <section style={{ padding: '120px 48px', maxWidth: 1160, margin: '0 auto' }}>
        <div style={{
          display: 'grid',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 32 }}>
              ...
              <div style={{ marginLeft: 'auto' }}>
                <span style={{
                  ...
                  padding: '4px 12px', borderRadius: 100, letterSpacing: '.06em',
                }}>
                  Live
                </span>
              </div>
            ...
            {DNA_BARS.map((row, i) => (
              <div key={row.label} style={{ marginBottom: i < DNA_BARS.length - 1 ? 16 : 0 }}>
            ...
            <div style={{ display: 'flex', gap: 0, marginTop: 32, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,.06)' }}>
              {[
                { val: '98', label: 'Played', color: '#FF3B7A' },
                { val: '7.4', label: 'Avg rating', color: '#00D4FF' },
                ...
                <div key={s.label} style={{
                  ...
                  <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginTop: 4, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>{s.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <p style={{
              fontSize: 12, fontWeight: 800, color: '#00D4FF',
              textTransform: 'uppercase', letterSpacing: '.15em', marginBottom: 16,
            }}>
              Gaming DNA
            </p>
            <h2 style={{
            ...
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.6)', lineHeight: 1.8, marginBottom: 32, fontWeight: 500 }}>
              You think you&apos;re an RPG fan, but are you really?
              Gaming DNA analyzes every game you&apos;ve ever logged
              and gives you a live breakdown of your true genre identity.
            </p>

            {[
              'Updates automatically with every game logged',
              'Covers 20+ genre categories',
              'Compare your DNA with friends',
              'Powers your personalized AI recommendations',
            ].map(item => (
              <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
                <div style={{
                  ...
                  <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <path d="M2 5l2.5 2.5L8 2" stroke="#00D4FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
      ...
      {/* ══════════════════ PRICING (GÜNCELLENDİ) ══════════════════ */}
      <section id="pricing" style={{ background: '#0E0E18', padding: '120px 48px', borderTop: '1px solid rgba(255,255,255,0.03)' }}>
        <div style={{ maxWidth: 480, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.6)', marginBottom: 48, fontWeight: 500 }}>
          ...
          <div style={{
            ...
            position: 'relative',
            boxShadow: '0 24px 80px rgba(0,212,255,.08)',
          }}>
            <div style={{
              ...
              padding: '6px 16px', borderRadius: 100, letterSpacing: '.08em',
              whiteSpace: 'nowrap', boxShadow: '0 4px 12px rgba(162,89,255,0.3)'
            }}>
              FOR POWER GAMERS
            </div>

            <div style={{ fontSize: 12, fontWeight: 800, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '.15em', marginBottom: 12 }}>
              Logary PRO
            </div>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 8, justifyContent: 'center' }}>
              <span style={{ fontSize: 48, fontWeight: 900, color: '#fff', letterSpacing: '-.04em' }}>$2.99</span>
              <span style={{ fontSize: 15, color: 'rgba(255,255,255,0.4)', fontWeight: 600 }}>/month</span>
            </div>
            <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)', marginBottom: 32, fontWeight: 500 }}>
              The ultimate toolkit for serious gamers tracking everything. Supported via Patreon.
            </p>

            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 40, textAlign: 'left', padding: 0 }}>
              {[
                'Custom Library Covers', 
                'Deep All-Time Stats', 
                'Expanded 10-Game Showcase',
                'Colored Username & PRO Badge'
              ].map(f => (
                <li key={f} style={{ display: 'flex', alignItems: 'center', gap: 12, fontSize: 14, color: '#ccc', fontWeight: 500 }}>
                  <div style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(0,212,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <svg width="10" height="10" viewBox="0 0 14 14" fill="none">
                      <path d="M2 7l3.5 3.5L12 3" stroke="#00D4FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  {f}
                </li>
            ...
            <a href="https://www.patreon.com/cw/logary" target="_blank" rel="noreferrer" style={{
              ...
              background: 'linear-gradient(135deg,#00D4FF,#A259FF)',
              color: '#fff', transition: 'transform .2s, box-shadow .2s', textDecoration: 'none'
            }}
      ...
      {/* ══════════════════ DOWNLOAD CTA ══════════════════ */}
      <section id="download" style={{ padding: '120px 48px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 640, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.6)', lineHeight: 1.6, marginBottom: 48, fontWeight: 500 }}>
            Join 240,000+ gamers who know exactly what they&apos;ve played,
            what&apos;s next, and who they are as a gamer.
          </p>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            >
              ...
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginBottom: 2, fontWeight: 600 }}>Download on the</div>
            ...
            >
              ...
              />
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginBottom: 2, fontWeight: 600 }}>Get it on</div>
